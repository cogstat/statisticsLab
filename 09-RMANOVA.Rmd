...
(1) Reaction times (RTs) were defined as the temporal interval between seeing a stimulus (to type) and then starting to type it (first key press).

(2) Inter-keystroke intervals (IKSIs) are the times between each key press.

(3) Accuracy was also measured (correct or incorrect key presses).
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3expvar_window.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3expvar_raw.png')
```

After looking at the raw data, we can say that most RT measurements are on the lower end of the scale, and very few RTs are higher than 5000ms. These measurements could have resulted from subjects being somehow distracted in the middle of the experiment. We want to remove those values so they do not influence the results. To do this choose “Data”, then “Filter outliers…”. 

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3filteroutliers_menu.png')
```

The next panel will ask you in which variable to filter the outliers, choose “PureRTs” and click “OK”.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3filteroutliers_window.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3filteroutliers_raw.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3filteroutliers_dataset.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.3filteroutliers_plot.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_icon.png')
```

or

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_menu.png')
```

In the dialogue, choose “Factors…” to specify the factor used in the analysis.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_window.png')
```

Here, new factors can be introduced with “Add factor”. Factors also can be modified and removed from the analysis.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_addfactor.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_info.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_raw.png')
```

In Sample Properties, the descriptive statistics for all conditions are provided, as well as boxplots with individual data.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_sampleproperties.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_boxplot.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_popprop.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_CI.png')
```

The last part of Population Properties is the hypothesis test.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.4CRMVAG_hyptest.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.5CRMVAG_window.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch9/9.5CRMVAG_hyptest.png')
```

According to the Wilcoxon signed-rank test, the Normal and Bigrams conditions are indeed significantly different, T=0.00, p<0.001. This same method can be used for the remaining comparisons.
