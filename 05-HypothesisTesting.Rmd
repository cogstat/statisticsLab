...
1. Sample 20 numbers for control group A with a normal distribution (20, mean=75, sd=5)

2. Sample 20 numbers for control group B with a normal distribution (20, mean=75, sd=5)

3. Compute the means for control groups A and B

4. Compute the difference between the mean for groups A and B

5. Save the differences score in a variable

6. Repeat as many times as we want  (repeating it many times over is called Monte Carlo simulation)

We generate the random numbers in spreadsheet software (here, in Excel), which you can load from the demo data under the name “Crumptest_ongenerateddata”. To generate  random numbers with a normal distribution we can write the following line into the formula bar =NORMINV(RAND(0;100);75;5). In this case twenty (N=20) numbers must be generated. Adding “id” and numbers from 1 to 20 makes it look more like a real dataset with participants. Now, this will be “Group A”. If you do the same procedure once again in the next column you can create “Group B”.

It is important that in spreadsheets we can also set the measurement level for the variables in a second row, which makes our work in CogStat easier. Now we can compute the means of both A and B groups. After loading the data in CogStat, choose “Analysis'' then “Explore variable…” and select both variables from “Available variables” as  “Selected variables” and press "OK ". 
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.2groupAdescr.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.2groupBdescr.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.4.1articlefigure1.png')
```
...
1. study-study: 42% or 0.42

2. study-test: 56% or 0.56
...
1. Our sample N is 40

2. The mean of our distribution is 0.49

3. The standard deviation of the distribution is 0.168

We can do this in a spreadsheet by using the following formula =NORMINV(RAND(0;100);0,49;0,168). With this, let’s generate two groups or you can use the file provided in the demo data, called “Crump_realdata”.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.4.1.5randGroup12.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.4.1.5randExpvarrawG1.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.4.1.5descrG1.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.4.1.5randExpvarrawG2.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.3.4.1.5descrG2.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.4Gab.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.4meandiff.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.4meandiffvariable.png')
```

After loading the data into CogStat, choose the “Explore variable” analysis on variable “meandiff_saved_as_variable”. 

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch5/5.4rawdata.png')
```
