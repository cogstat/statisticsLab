...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_icon.png')
```

or

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_menu.png')
```

Select “intellect” as the dependent variable and “CONDITION” as “Group”, then press “OK”. 

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_window.png')
```

The output is very similar to our previous examples and can be interpreted similarly. First, take a look at the raw data.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_raw.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_plot.png')
```

In Sample properties, there are descriptives for both conditions, as well as standardised effect sizes are provided.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_sp.png')
```

Here a boxplot shows the individual data’s attributes.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_boxplot.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_CI.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_CIplot.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch7/7.3comparegroups_hyptest.png')
```
