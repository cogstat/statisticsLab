...
## Answering Questions with Data in CogStat
...
```{r 2rlogo, echo=FALSE,dev='png'}
knitr::include_graphics('img/intro/opendemodata_menu.png')
```

or

```{r 2rlogo, echo=FALSE,dev='png'}
knitr::include_graphics('img/intro/opendemodata_icon.png')
```
...
```{r 2rlogo, echo=FALSE,dev='png'}
knitr::include_graphics('img/intro/measurementlevels.png')
```
...
For more on handling data: https://doc.cogstat.org/Handling-data.
...
```{r 2rlogo, echo=FALSE,dev='png'}
knitr::include_graphics('img/intro/reloadfile_menu.png')
```

or

```{r 2rlogo, echo=FALSE,dev='png'}
knitr::include_graphics('img/intro/reload_icon.png')
```
