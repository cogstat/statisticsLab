...
First, let’s open the relevant data file in CogStat, called “Jamesetal2015_Experiment2”.
...
To compare more than two groups in CogStat, choose “Analysis” and then “Compare groups…” As before, CogStat will choose the suitable analysis after checking the assumptions.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_menu.png')
```

or

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_icon.png')
```

As mentioned, the independent variable will be “Condition” and the dependent variable will be “Days_One_to_Seven_Number_of_Intrusions”, so the following steps should be done.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_window.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_raw.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_rawplot.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_sampleprop.png')
```

Boxplots are also provided in this section to illustrate these differences. 

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_boxplot.png')
```

Population properties provide confidence intervals in a numeric way as well as in graphs. 

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_popprop.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_medians_histo.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_hyptest.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch8/8.3comparegroups_posthoc.png')
```
