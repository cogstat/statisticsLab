...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/sample.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.2descftv_random.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.2histogram_random.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/morefives.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/morefivesfreq.png')
```

As you see more than half of the generated numbers turned out to be 5 (54% of all).

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/morefiveshisto.png')
```
...
Let’s take 100 random numbers between 0 and 5 and plot the histogram. You can either open the file 4.3_uniform from the demo data or generate your own data. To do this, we will use the “=RANDBETWEEN()” command in the spreadsheet. Write “=RANDBETWEEN(0;5)” into the formula bar or in a given cell.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3randbetween_function.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3randinexcel.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3expvarraw.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3randrawhisto.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3randsampleprop.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3randsamplepropfor10000.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.3randhistofor10000.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.4coinflip1trial.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.4coinflipmoretrials.png')
```

This way we have in row K the sums of all trials when we flipped a coin ten times and got heads. This variable contains 100 trials, but we could do this as many times as needed. This file is available in the demo data under the name “4.4_binomial”. The variable, named “sum” can be analysed in CogStat, so load this dataset and choose the “Explore variable” analysis. We can see the frequency traits of the variable in a histogram and frequency tables in Raw data and in Sample properties.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.4expvarraw.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.4binomdistr.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.5normdistr.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.5egiq.png')
```

Picture from: (Wikipedia- https://en.wikipedia.org/wiki/Intelligence_quotient)
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.5expvarraw.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.5expvarrawdescr.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.5normalhisto.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.6samplemeans.png')
```

The dataset “4.7_sdm” contains means of generated, normally distributed samples of ten, with a mean of zero and a standard deviation of one in the second coloumn. All these means come from the same normal distribution, but many of them are quite different from each other. This is because of random sampling error, random chance makes each sample a little bit different (e.g., you don’t always get five heads and five tails when you flip a coin). Open the file “4.7_sdm” from demo data and run an “Explore variable” analysis on the “sample_means” variable.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.6expvarsamplemeansRAW.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.6samplemeansdescriptives.png')
```

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.6samplemeanshisto.png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.6samplemeanshisto(moretrials).png')
```
...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/ch4/4.6samplemeansdescriptives(more).png')
```
